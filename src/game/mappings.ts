...
export const TECHNOLOGY_TO_NAME: Record<Technology, string> = {
  ...
  [Technology.BEER_TESTER]: 'Beer tester',
  [Technology.WHEELBARROW]: 'Wheelbarrow',
  [Technology.WEAPONSMITH]: 'Weaponsmith',
  [Technology.ARMOURSMITH]: 'Armoursmith',
  [Technology.IRON_HARDENING]: 'Iron hardening',
  [Technology.POISON_ARROWS]: 'Poison arrows',
  [Technology.HORSE_BREEDING]: 'Horse breeding',
  [Technology.FLAMING_ARROWS]: 'Flaming arrows',
  [Technology.BLACKSMITH]: 'Blacksmith',
  [Technology.MAP_OF_AREA]: 'Map of area',
  [Technology.CISTERN]: 'Cistern',
  [Technology.FORTRESS_CONSTRUCTION]: 'Fortress construction',
